...
export function GamesCard(props: GamesCardProps) {
    return (
        <div className='relative rounded-md flex-col text-center bg-primary-800 w-full max-w-96 md:h-[440px] flex items-center px-8 mb-10'>
            ...
            <h3 className="font-bold mt-10 md:mt-24 text-primary-100 py-4">{props.title}</h3>
