...
export function Contact() {
    return (
        <section className="block overflow-x-clip px-[120px] w-full max-h-[1040px]">
            <div>
                <h4 className="font-bold text-xx-large text-primary-700 opacity-5 py-3 -ml-40">
                    Contact Us
                </h4>
            </div>
            <div className="flex pb-10 flex-row flex-1 w-full -mt-40 gap-4">
                <div className="max-w-[751px] w-full">
                    <h5 className="text-x-medium">
                        Send a message
                    </h5>
                    <form action="#" className="drop-shadow-xl rounded-lg mt-9 bg-primary-900 flex max-h-[610px] w-full max-w-[648px] px-[70px] pt-[67px] pb-[70px] flex-col">
                        <label htmlFor="email" className="mb-1 text-primary-100 font-semibold">
                            Enter your email
                        </label>
                        <input className="w-full max-w-[343px] h-10 rounded-sm" type="email" id="email" name="email" />
                        ...
                        <button className='mt-12 w-60 font-bold rounded text-primary-900 py-1 bg-primary-200'>
                            Send Message
                        </button>
                    </form>
                </div>
                <div>
                    ...
                    <div className="drop-shadow-xl mt-9 rounded-t-lg bg-primary-900">
                        <h6 className="font-bold max-text-[28px] text-primary-200 py-[26px] px-[34px]">Follow us on social media!</h6>
